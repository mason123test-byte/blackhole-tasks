...
float tangentAxisFocusingAlignment(
  float r,
...
float tangentFocusingAnisotropy(
  float r,
  float srRight, float sthetaRight, float sprRight, float spthetaRight,
  float srUp, float sthetaUp, float sprUp, float spthetaUp
) {
  float cameraRightFocusing = tangentAxisFocusingAlignment(r, srRight, sthetaRight, sprRight, spthetaRight);
  float cameraUpFocusing = tangentAxisFocusingAlignment(r, srUp, sthetaUp, sprUp, spthetaUp);
...
void shapeIncidenceQualifiedDirectShoulder(
  ...
  float focusingAnisotropySupport,
