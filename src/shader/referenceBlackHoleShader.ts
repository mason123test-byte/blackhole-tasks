...
fragment = replaceOnce(
  ...
  "  bool captured = false; int diskCrossingCount = 0; vec3 accumulatedDisk = vec3(0.0); float transmittance = 1.0; float pathLength = 0.0; float jacobiSeparation = 0.0; float jacobiSlope = 1.0;",
);
fragment = replaceOnce(
  fragment,
