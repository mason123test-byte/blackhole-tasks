...
float tangentPhaseFocusingAlignment(
  float r,
  ...
  vec4 configurationDisplacement = vec4(
    srRight / safeR, sthetaRight,
    srUp / safeR, sthetaUp
  );
  vec4 momentumDisplacement = vec4(
    sprRight, spthetaRight / safeR,
    sprUp, spthetaUp / safeR
  );
...
void shapeIncidenceQualifiedDirectShoulder(
  ...
  float focusingAlignmentSupport,
