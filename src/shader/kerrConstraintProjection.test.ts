...
describe("Kerr float32 constraint projection", () => {
  it("reprojects canonical momenta onto the conserved Kerr potentials after accepted steps", () => {
    ...
    expect(REFERENCE_BLACK_HOLE_FRAGMENT).toContain("projectKerrMomenta(r, theta, L, kappa, pr, ptheta);");
  });

  it("keeps integrated momentum signs so real Kerr turning points remain physical", () => {
